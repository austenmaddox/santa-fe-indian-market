...
function setup() {
  ...
  nodes.push(new Node("Indian Fair Committee", w * 0.55, 100, 1927, "Santa Fe, NM", "Up until 1926, the Musuem of New Mexico was running the fairs. In 1927, the Indian Fair Committee took over, but ran the fair in the same format as the museum with prizes and sales."));
